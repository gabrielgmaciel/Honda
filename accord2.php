            ...
            <div class="container-fliud">
                <div class="wrapper row">
                    ...
                    <div class="details col-md-6">
                        ...
                        <h4 class="price">Preço do Veículo: <span>R$ 163.000,00</span></h4>
                        <div class="form-group form-inline">
                            <h4 class="sizes">Entrada:   <input type="number" class="form-control" id="entradaAccord" placeholder="R$ 000.000,00"></h4>
                            <h4 class="sizes">Parcelas:
                                <select class="form-control" id="parcelaAccord">
