            ...
            <div class="wrapper row">
                <div class="preview col-md-6">
                    ...
                    <div class="preview-pic tab-content">
                        <div class="tab-pane active"><img src="imagens/city/06.jpg" /></div>
                    </div>
                </div>
                <div class="details col-md-6">
                    ...
                    <h4 class="price">Preço do Veículo: <span>R$ 81.400,00</span></h4>
                    <div class="form-group form-inline">
                        <h4 class="sizes">Entrada:   <input type="number" class="form-control" id="entradaCity" placeholder="R$ 000.000,00"></h4>
                        <h4 class="sizes">Parcelas:
                            <select class="form-control" id="parcelaCity">
